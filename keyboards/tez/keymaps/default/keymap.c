...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUMPAD] = LAYOUT_v3(
            ...
            KC_LALT,             KC_CUT,              KC_COPY,             KC_PASTE,            KC_TRANSPARENT,             KC_PLUS,             KC_1,                KC_2,                KC_3,                KC_KP_DOT,
                                                      KC_NUMLOCK,          KC_TRANSPARENT,      QK_BOOTLOADER,              KC_TRANSPARENT,      KC_TRANSPARENT,      KC_0
    ),
    [MOUSE_F] = LAYOUT_v3(
    ...
    [SYMB] = LAYOUT_v3(
            KC_CH_LNG,           KC_ESCAPE,           KC_ENTER,            KC_TRANSPARENT,      KC_TRANSPARENT,             KC_BSLASH,           RSFT(KC_BSLASH),     KC_QUOTE,            KC_DQUO,             KC_TRANSPARENT,
